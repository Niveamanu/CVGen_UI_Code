    ...
    const getUserRoles = async () => {
      ...
      try {
        ...
        if (graphResponse.ok) {
          ...
          const isAdmin = userGroups.includes('CVGen_RegulatoryUsers') || userGroups.includes('Flourish_Admin_Group')
          const isUser = userGroups.includes('CVGen_BusinessUsers') || userGroups.includes('Flourish_User_Group')
         
          console.log('🔍 User roles determined:', {
            userGroups,
            isAdmin,
            isUser,
            hasAdminGroup: userGroups.includes('CVGen_RegulatoryUsers') || userGroups.includes('Flourish_Admin_Group'),
            hasUserGroup: userGroups.includes('CVGen_BusinessUsers') || userGroups.includes('Flourish_User_Group')
          })
