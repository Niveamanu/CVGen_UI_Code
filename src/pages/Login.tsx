    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <motion.div className={styles.loginTitle}>Login</motion.div>
          <motion.div className={styles.loginSubtitle}>
      ...
      <motion.div
        className={
          styles.rightPanel +
          " d-none d-md-flex flex-column justify-content-center align-items-center"
        }
      ...
      >
        ...
        >
          Professional branded CV tailored to showcase the doctor's strengths
          and career goals
        </motion.p>
      </motion.div>
    </motion.div>
